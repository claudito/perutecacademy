...
<form action="controlador/actualizar.php" method="POST" autocomplete="off" class="form-inline">

<input type="hidden" name="id"  
 value="<?php echo Usuario::consulta($_GET['id'],'id') ?>">


<label>Nombres</label>
<input type="text" name="nombres" id=""  required="" 
 class="form-control" 
  value="<?php echo Usuario::consulta($_GET['id'],'nombres') ?>">

<label>Apellidos</label>
<input type="text" name="apellidos" id="" required="" class="form-control"
 value="<?php echo Usuario::consulta($_GET['id'],'apellidos') ?>">

<label>Dni</label>
<input type="text" name="dni" id="" required=""  maxlength="8" class="form-control" value="<?php echo Usuario::consulta($_GET['id'],'dni') ?>">
