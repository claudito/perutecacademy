...
<input type="text" name="descripcion" id="" class="form-control" value="<?php echo $articulos->consulta($codigo,'descripcion'); ?>">
</div>
...
<?php 
$unidad   =  $articulos->consulta($codigo,'unidad');
$unidades  = new Unidades();
foreach ($unidades->listar() as $key => $value): ?>
<?php if ($value['codigo']!==$unidad): ?>
...
<script>
    ...
    var parametros = $(this).serialize();
     $.ajax({
          type: "POST",
          url: "../controlador/articulos/actualizar.php",
          data: parametros,
