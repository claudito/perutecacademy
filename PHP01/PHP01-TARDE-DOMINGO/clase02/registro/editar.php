...
$id;
$id = $_GET['id'];
?> <!-- Fijar horario de la zona actual -->
<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8">
...
<body>
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-4">
        <h1 class="text-center">Editar Datos de ALumno</h1><hr> <!-- (hr) para subrayado -->
        <form action="actualizar.php" method="POST" autocomplete="on">
          <div class="form-group">
          <label>Nombres</label>
          <input type="text" name="nombres" id="" class="form-control" required="" placeholder="Nombres"  value="<?php echo $alumno->consulta($id,'nombres'); ?>">
          </div>
          <div class="form-group">
          <label>Apellidos</label>
          <input type="text" name="apellidos" id="" class="form-control" required="" placeholder="Apellidos" value="<?php echo $alumno->consulta($id,'apellidos'); ?>">
          </div>
          <div class="form-group">
          <label>Edad</label>
          <input type="number" min="18" value="<?php echo  $alumno->consulta($id,'edad'); ?>" name="edad" id="" class="form-control" required="" placeholder="Edad">
          </div>
