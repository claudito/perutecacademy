  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li class="disabled" ><a href="#">Alumnos</a></li>
            <li class='disabled'><a href="#">Profesores</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#"><i class="glyphicon glyphicon-user text-success "></i> Luis Augusto</a></li>
        <li class="dropdown">
